...
void main() {
  testWidgets('Location check page UI test', (WidgetTester tester) async {
    ...
    // Verify that the radio button for 'Computer' is selected by default.
    final radioFinder = find.byType(Radio<String>);
    expect(radioFinder, findsNWidgets(2));

    // We can check if the elevated button exists.
